...
def main():
    ...
    metadata_cols = inherited_options.metadata_cols # metadata_cols = "sanger_sample_id,Genotyping_ID,disease_status,predicted_labels"
    ...
    # 4. Extract and save
    print("..Saving")
    to_save = adata.obs[metadata_cols.append(gene_list_name)]   
