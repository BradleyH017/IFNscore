#!/usr/bin/env python
#### Script taken from yascp (https://github.com/wtsi-hgi/yascp/blob/71d752aa4898ca7e08dd28ceef4b97b1b30cbd4a/bin/h5ad_to_tenxmatrix.py#L5)
import anndata
import scipy.io
import os
import pandas as pd
...
if __name__ == "__main__":
    ...
    # args.h5ad_path="/lustre/scratch127/humgen/projects_v2/sc-eqtl-ibd/analysis/bradley_analysis/IBDverse/atlassing/results/objects/from_irods/celltypist_0.5_ngene_ncount_mt_filt_nomiss.h5ad"
